            ...
            else if (file_size <= squares)
            {
                ...
                img.onload = function () 
                {
                    ...
                    if (w == final_width && h == final_height)
                    {
                        ...
                        {
                            $( ".form-info-5" ).empty();
                            msg = "Image dimension does mach selected are!";
                            $( ".form-info-5" ).html(msg);
                    ...
                    else if ( squares > adMaxSquareA)
                    {
                        msg = "Free Ad can be only "  + (adMaxWa / 10) + "x" + (adMaxHa / 10) +  " squares or "  + adMaxWa + "x" + adMaxHa + " pixels, or less!";
                    ...
                    else
                    {
                        ...
                        msg = "Image dimension does not mach selected area! <br />" +
                                  ...
                                  "You can upload image, but it will be scaled unproportionately.";
